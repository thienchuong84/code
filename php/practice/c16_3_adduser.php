...
_END;
	...
	// Sau khi qua các hàm kiểm tra, đây là nới xử lý database để add user vào từ các biến trên.
	// chú ý phần xử lý hash pass khi into vào database
	
	exit; // chú ý là khi đã show cái trên, ta cần dùng hàm này để ko load ở phía dưới nữa.
}
?>
...
<body>
	<table class="signup" border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee">
		...
		<tr><td colspan="2">Sorry, the errors was founded<br> in your form: <p><font color="red" size="1"><i><?php echo $fail; ?></i></font></p></td></tr>
		<form method="post" action="c16_3_adduser.php" onsubmit="return validate(this)">
			<tr>
				<td>Forename</td>
	...
	<script type="text/javascript">
		...
		function validatePassword(field){
			if(field == "") return "Password was not entered.\n"
		...
		function validateAge(field){
			if(isNaN(field)) return "No Age was entered.\n"
				...
				return "Age mus be between 18 and 110.\n"
			return ""
		}

		function validateEmail(field){
			if(field == "") return "Email was not entered.\n"
...
function validate_email($field){
	if($field == "")
		...
		return "The Email address is invalide.<br>";
	return "";
}
